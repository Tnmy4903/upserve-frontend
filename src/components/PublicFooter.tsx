  ...
  return (
    <footer className="public-footer" aria-label="Upserve footer">
      <div className="public-footer__inner">
        <div className="public-footer__brand">
          <Link
            ...
            to="/"
            aria-label="Upserve home"
          >
            <BrandLogo />
          </Link>
          <p>
            Upserve builds websites, apps, AI tools and custom software —
            end-to-end, from requirement to delivery.
          </p>
          <p>
            Contact us at{" "}
            <a href="mailto:contact@upserve.in">contact@upserve.in</a>
          </p>
        </div>
        <div className="public-footer__column">
          ...
          <ul>
            {services.map((service, index) => (
              <li key={service}>
                <Link to={`/services#service-${index + 1}`}>{service}</Link>
              </li>
            ))}
          </ul>
        </div>
        <nav className="public-footer__column" aria-label="Footer navigation">
          ...
          <ul>
            <li>
              <Link to="/portfolio">
                Our Work <ArrowUpRight size={13} aria-hidden="true" />
              </Link>
            </li>
            <li>
              <Link to="/showcase">
                Platform Showcase <ArrowUpRight size={13} aria-hidden="true" />
              </Link>
            </li>
            <li>
              <Link to="/blogs">
                Insights <ArrowUpRight size={13} aria-hidden="true" />
              </Link>
            </li>
            <li>
              <Link to="/about">
                About Upserve <ArrowUpRight size={13} aria-hidden="true" />
              </Link>
            </li>
          </ul>
        </nav>
        <div className="public-footer__column public-footer__contact">
          ...
          <Link className="public-footer__contact-link" to="/contact">
            Start a Project <ArrowUpRight size={15} aria-hidden="true" />
          </Link>
          <Link className="public-footer__client-portal" to="/login">
            Client Portal
          </Link>
          <div className="public-footer__socials">
            ...
            <a
              href="https://www.instagram.com/tnmy4903/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://github.com/tnmy4903/"
              target="_blank"
              rel="noreferrer"
            >
      ...
      <div className="public-footer__bottom">
        <div>
          <span>
            © {new Date().getFullYear()} Upserve. All rights reserved.
          </span>
        ...
        <div className="public-footer__legal">
          ...
          <details>
            ...
            <p>
              By using our services, you agree to our terms of service, project
              policies, and payment terms outlined in our proposals and
              agreements.
            </p>
          </details>
        </div>
