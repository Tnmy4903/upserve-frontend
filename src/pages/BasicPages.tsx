...
export function ForbiddenPage() {
  useSEO({ title: 'Access denied | Upserve', description: 'This private Upserve page is not available.', path: '/forbidden', indexable: false });
...
export function NotFoundPage() {
  useSEO({ title: 'Page not found | Upserve', description: 'The requested Upserve page was not found.', indexable: false });
