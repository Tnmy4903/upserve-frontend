...
export function ChangePasswordPage() {
  useSEO({
    title: "Change password | Upserve",
    description: "Private Upserve account password update.",
  ...
  return (
    <main className="auth-page">
      <form className="auth-card" onSubmit={submit}>
        ...
        <p>
          Choose a new password for your Upserve account. Use a password you do
          not reuse elsewhere.
        </p>
        ...
        <label htmlFor="new-password">
          ...
          <PasswordInput
            ...
            onToggle={() =>
              setVisible((value) => ({ ...value, next: !value.next }))
            }
        ...
        <label htmlFor="confirm-password">
          ...
          <PasswordInput
            ...
            onToggle={() =>
              setVisible((value) => ({ ...value, confirm: !value.confirm }))
            }
            autoComplete="new-password"
          />
        </label>
    ...
    <div className="password-guidance" aria-live="polite">
      ...
      <ul>
        {checks.map(({ label, passed }) => (
          <li key={label} className={passed ? "is-passed" : ""}>
            {passed ? "✓" : "○"} {label}
          </li>
        ))}
      </ul>
